...
async function main() {
    ...
    const getcontract = await ethers.getContractFactory("PatoFinanceBSc");
    ...
    console.log(`This is the script of the pato BSc token code from openzeppelin right here @ ${getcontractaddress}`);
